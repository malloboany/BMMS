    ...
    <body class="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
        <header class="border-b bg-white/80 backdrop-blur">
            <div class="max-w-6xl mx-auto flex items-center justify-between px-4 py-4">
                <a href="#home" class="flex items-center gap-2">
                    <span class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-primary-600 text-white font-semibold">
                        B
                    </span>
                ...
                <nav class="hidden md:flex items-center gap-3 text-sm">
                    ...
                    <a href="{{ url('/login') }}" class="px-3 py-1.5 rounded-md hover:bg-primary-50">Login</a>
        ...
        <main id="home" class="flex-1">
            <section class="max-w-6xl mx-auto px-4 py-12 lg:py-20 flex flex-col-reverse lg:flex-row items-center gap-10">
                <div class="flex-1">
                    <p class="inline-flex items-center gap-2 text-xs font-medium text-primary-700 bg-primary-50 px-3 py-1 rounded-full mb-4">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="{{ url('/login') }}" class="inline-flex items-center px-5 py-2.5 rounded-md bg-primary-600 text-white text-sm font-medium hover:bg-primary-700">
                            Log in to dashboard
                        </a>
                        <a href="#about-us" class="inline-flex items-center px-5 py-2.5 rounded-md border border-slate-200 text-sm font-medium text-slate-800 hover:bg-slate-100">
                            Learn more
                        </a>
                    </div>
                </div>
                ...
                <div class="flex-1">
                    <div class="relative">
                        <div class="absolute -inset-4 rounded-3xl bg-gradient-to-tr from-primary-200 via-emerald-100 to-sky-200 opacity-60 blur-2xl"></div>
                        <div class="relative rounded-3xl bg-white shadow-xl overflow-hidden border border-slate-100">
                            <img
                                ...
                                alt="Booking and calendar management illustration"
                            ...
                            <div class="p-4 border-t border-slate-100">
                                ...
                                <p class="text-sm text-slate-700">
                                    From first request to confirmed seat, follow your training bookings step by step with clear statuses and actions.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="max-w-6xl mx-auto px-4 py-10 lg:py-14 grid gap-8 lg:grid-cols-2">
                    <div>
                        ...
                        <p class="text-slate-700 text-sm mb-3">
                            Illaftrain is a specialized training center network focusing on practical, career‑oriented education.
                        ...
                        <a
                            href="https://www.illaftrain.co.uk/ar/location/TUR"
                            target="_blank"
                    ...
                    <div class="text-sm text-slate-700">
                        ...
                        <p class="mb-3">
                            ...
                            BMMS aims to provide a clean interface for administrators while staying flexible for future modules
            ...
            <section id="privacy" class="border-t bg-slate-50">
                <div class="max-w-6xl mx-auto px-4 py-10 lg:py-12">
                    ...
                    <p class="text-sm text-slate-700 mb-2">
                        Booking data (such as participant names, contact details, and session information) is stored securely
                        in a MySQL database managed by Laravel. Access to administrative pages is protected and can be extended
                ...
                <div class="max-w-6xl mx-auto px-4 py-10 lg:py-12 grid gap-8 lg:grid-cols-[1.2fr,1fr] items-center">
                    <div>
                        ...
                        <p class="text-sm text-slate-700 mb-4">
                            Mohammed is passionate about building tools that make everyday operations easier for training centers,
                            instructors, and administrators.
                        </p>
                        <a
                            href="https://www.linkedin.com/in/mohammed-alloboany/"
                            target="_blank"
                            rel="noopener noreferrer"
